...
export default function Credits() {
  return (
    <main className="container v-centered">
      <section className="section hero has-text-left">
        <h1 className="title">
          Credits
        </h1>
        ...
        <div className="content">
          <ul>
            ...
            <li>
              Some icons made by
              <a href="https://www.flaticon.com/authors/gravisio" title="gravisio"> gravisio</a> from
              <a href="https://www.flaticon.com/" title="Flaticon"> www.flaticon.com</a>
            </li>
          </ul>
        </div>
