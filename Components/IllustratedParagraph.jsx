...
export default function IllustratedParagraph({children, image, imageClass, imageHref, paragraphLeft = false, textColumnClasses = "", imageColumnClasses = "is-one-quarter" }) {
    let imageDom;
    if (imageHref) {
